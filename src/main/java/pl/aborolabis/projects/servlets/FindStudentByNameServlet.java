...
@WebServlet(name="findbyname", value="/findbyname")
public class FindStudentByNameServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<Student> studentByHisName = studentsServices.findStudentByHisName(name);
        ...
        out.println("<html>\n" +
                ...
                "    <p>Students found by name (" + name + "):</p>" +
                "<table id=\"tablee\">\n" +
                "<tr>\n" +
                "<th>Name:</th>\n" +
                "<th>Class Number:</th>\n" +
        ...
        for(Student student : studentByHisName){
            out.println("    <tr>\n" +
